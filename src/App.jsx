...
const NotFoundView = () => {
    return <section className='container flex flex-col items-center justify-center h-full my-auto '>
        <MessageSquareX size={92} className='text-red-500' />
        <h1 className='title'><FormattedMessage id='notfound.title' /></h1>
        <Link className={'bg-primary text-white  px-5 py-3 rounded-lg font-bold shadow-xl border hover:opacity-70 transition-all duration-200'} href='/'><FormattedMessage id='notfound.link' /></Link>
    </section>
}
function App() {
        ...
        <>
            ...
            <main className='bg-slate-50 py-5 min-h-[calc(100svh-124px-64px)]'>
                <Switch>
                    ...
                    <Route path='/usefulInfo/students' component={UsefulInfoStudentsPage} />
            ...
            <footer className='w-full flex justify-center bg-primary p-5 h-16 text-white'>2025</footer>
        </>
    )
}
